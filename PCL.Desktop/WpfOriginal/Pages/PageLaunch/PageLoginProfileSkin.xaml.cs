...
public partial class PageLoginProfileSkin
{
    ...
    private void Skin_Click(object sender, RoutedEventArgs e)
    {
        ...
        else
        {
            ...
            {
                ModMain.Hint(Lang.Text("Launch.OfflineSkin.NoOfficialProfile"));
                return;
            }
            ...
            var sel = ModMain.MyMsgBoxSelect(items, Lang.Text("Launch.OfflineSkin.Select"),
            ...
            if (sel is >= 0)
            {
                ...
                if (!wasBorrowing && sel > 0 &&
                    ModMain.MyMsgBox(
                        Lang.Text("Launch.OfflineSkin.LoaderRequired.Message"),
                        Lang.Text("Launch.OfflineSkin.LoaderRequired.Title"),
                        Lang.Text("Launch.OfflineSkin.LoaderRequired.Confirm"),
                        Lang.Text("Common.Action.Cancel"), isWarn: true, forceWait: true) == 2)
                    return;
                ...
                ModMain.Hint(Lang.Text("Launch.OfflineSkin.Updated"));
                Skin.loader.Start(isForceRestart: true);
            }
        }
    }

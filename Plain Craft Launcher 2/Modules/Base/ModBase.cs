...
using MD5Provider = PclPortable::PCL.Core.Utils.Hash.MD5Provider;
using SHA1Provider = PclPortable::PCL.Core.Utils.Hash.SHA1Provider;
using SHA256Provider = PclPortable::PCL.Core.Utils.Hash.SHA256Provider;
using SHA512Provider = PclPortable::PCL.Core.Utils.Hash.SHA512Provider;
